...
class ReleaseArtifactReplayGateTests(unittest.TestCase):
    ...
    def test_release_gate_reaches_real_models_only_after_transcript_replay_passes(self) -> None:
        ...
        self.assertEqual(visited[-7:], ("artifact_replay", "transport_replay",
            "native_command_replay", "real_model_failure_replay", "entrypoint_boot",
    ...
    def test_real_model_failure_replay_failure_prevents_all_model_backed_stages(self) -> None:
        visited = execute_mandatory_stage_sequence(
            RELEASE_STAGES, lambda name: name != "real_model_failure_replay",
        )
        self.assertEqual(visited[-1], "real_model_failure_replay")
        self.assertFalse(MODEL_BACKED_STAGES.intersection(visited))
    ...
    def test_model_backed_stages_cannot_move_before_replay(self) -> None:
        ...
        for invalid in (
            ("native_roles", "artifact_replay", "transport_replay",
             "native_command_replay", "real_model_failure_replay", "entrypoint_boot", "real_models"),
            ("real_models", "artifact_replay", "transport_replay",
             "native_command_replay", "real_model_failure_replay", "entrypoint_boot", "native_roles"),
            ("native_roles", "real_models"),
            ("artifact_replay", "artifact_replay", "transport_replay",
             "native_command_replay", "real_model_failure_replay", "entrypoint_boot", "native_roles", "real_models"),
            ...
            ("artifact_replay", "transport_replay", "entrypoint_boot",
             "native_command_replay", "real_model_failure_replay", "native_roles", "real_models"),
            ...
            ("self_check", "future_model_stage", "artifact_replay",
             ...
             "real_model_failure_replay", "native_roles", "real_models"),
            ("artifact_replay", "transport_replay", "native_command_replay",
             "real_model_failure_replay", "entrypoint_boot", "future_model_stage", "native_roles", "real_models"),
            ("artifact_replay", "transport_replay", "native_command_replay",
             "real_model_failure_replay", "native_roles", "entrypoint_boot", "real_models"),
            ("artifact_replay", "transport_replay", "native_command_replay",
             "entrypoint_boot", "native_roles", "real_models"),
            ("artifact_replay", "transport_replay", "native_command_replay",
             "entrypoint_boot", "real_model_failure_replay", "native_roles", "real_models"),
        ):
