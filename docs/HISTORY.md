...
Актуальные rationale, отвергнутые альтернативы и условия пересмотра находятся в
[журнале решений](DECISIONS.md). Ниже сохранены исторические срезы; их версии и
формулировки future work не заменяют текущую архитектуру.
