# Документация Slivin Harness 0.8.0a10

Актуальная версия: **0.8.0a10 — Phase 7**.
...
- [`PHASE7_FINAL_GATE.md`](PHASE7_FINAL_GATE.md) — one-candidate reconciliation, patch proof, delivery и benchmark isolation.
